...
st.markdown("""
<div style="background-colour: #EEEEE4; text-align: center;">
    <div style="colour: #ffffff; font-size: 20px;">
...
with st.form("triange_form"):
    ...
    with c4:
        nausea_vomitting = st.checkbox("neusea vomiting")
        dizzinees = st.checkbox("dizzinees")
